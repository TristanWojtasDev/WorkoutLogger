...
- Create Angular project with ng: `ng new workoutlogger.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`workoutlogger.client.esproj`).
